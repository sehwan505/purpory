"""Tests for the language resolver registry (purpory.resolver_registry).
...
from purpory.resolver_registry import (
    LanguageResolver,
...
def test_default_registry_contains_swift_then_python() -> None:
    ...
    import purpory.extract  # noqa: F401  (registers resolvers on import)
