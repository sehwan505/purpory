...
affected.load_graph (`purpory prs`), and diagnostics._read_json_file
(`purpory diagnose`). A truncated / invalid file (incomplete write, power loss,
...
from purpory.build import build_merge
from purpory.affected import load_graph
from purpory.diagnostics import _read_json_file
