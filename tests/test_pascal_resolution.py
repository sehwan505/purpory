...
file's own scope. purpory.pascal_resolution closes that gap as a
...
from purpory.extract import extract, extract_pascal
...
def test_calls_resolve_across_files_via_inherits_chain(tmp_path):
    # cache_root only controls where purpory-out/cache/ is written -- it has
