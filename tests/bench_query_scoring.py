...
def _load_real_graph(path: str) -> nx.Graph:
    ...
    `purpory-out/graph.json`, skipping the size cap and work-memory overlay
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument("--graph", default=None,
                   help="optional path to a real purpory-out/graph.json; overrides --nodes")
