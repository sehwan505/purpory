...
Example output:
    === Purpory AST Extraction Benchmark ===
    Files:        1,247
...
from purpory.extract import extract, collect_files
from purpory.cache import clear_cache
...
def main() -> None:
    ...
    print("=== Purpory AST Extraction Benchmark ===\n")
