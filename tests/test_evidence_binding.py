"""Tests for semantic evidence-binding in purpory.llm.
...
def test_unverified_flag_does_not_fail_validation():
    ...
    from purpory.validate import validate_extraction
...
def test_diagnostics_reports_unverified_node_count():
    ...
    from purpory.diagnostics import diagnose_extraction, format_diagnostic_report
