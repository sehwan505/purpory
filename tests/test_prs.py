...
class TestFetchWorktrees:
    def test_normal_case_maps_branch_to_path(self):
        ...
        with patch("purpory.prs.subprocess.run", return_value=mock_result):
...
class TestDetectDefaultBranch:
    ...
    def test_gh_returns_empty_dict_falls_back(self):
        ...
        with patch("purpory.prs._gh", return_value={}), patch(
            "purpory.prs.subprocess.run", return_value=mock_result
        ):
