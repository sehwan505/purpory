...
from purpory.extract import extract_python, extract, collect_files, _make_id, extract_bash, extract_json, _DISPATCH
...
def test_collect_files_from_dir():
    from purpory.extract import _DISPATCH
...
def test_extract_generic_surfaces_tree_sitter_version_mismatch_hint(monkeypatch):
    ...
    import sys
    import types
    from purpory.extract import _extract_generic, LanguageConfig
...
def test_extract_js_destructured_require_imports_from():
    ...
    from purpory.extract import extract_js
...
def test_extract_js_destructured_require_named_symbols():
    ...
    from purpory.extract import extract_js, _make_id, _file_stem
    result = extract_js(FIXTURES / "cjs_require.js")
...
def test_extract_tsx_uses_tsx_grammar():
    ...
    from purpory.extract import _TSX_CONFIG, _TS_CONFIG
...
def test_semantic_reference_edges_carry_context_and_source():
    from purpory.extract import _semantic_reference_edge
...
def test_dart_child_node_ids_are_stem_based(tmp_path):
    ...
    from purpory.extract import extract_dart, _file_stem, _make_id
...
def test_get_extractor_routes_matlab_m_away_from_objc(tmp_path):
    ...
    from purpory.extract import _get_extractor, extract_objc
...
def test_rewire_binds_cross_module_function_reference_to_definition():
    ...
    rewire targets)."""
    from purpory.extract import _rewire_unique_stub_nodes
    nodes = [
