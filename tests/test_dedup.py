"""Tests for purpory/dedup.py entity deduplication pipeline."""
from __future__ import annotations
import pytest
from purpory.dedup import deduplicate_entities, _defines_id, _entropy, _shingles
...
def test_build_calls_dedup():
    ...
    from purpory.build import build
    chunk1 = {
...
def test_dedup_still_merges_real_typos():
    ...
    from purpory.dedup import _is_variant_pair, _short_label_blocked
...
def test_variant_pair_helper():
    ...
    from purpory.dedup import _is_variant_pair
...
def test_prefix_guard_does_not_block_same_length_typos():
    ...
    from purpory.dedup import _norm
...
def test_numeric_tokens_differ_helper():
    ...
    multisets (#1284)."""
    from purpory.dedup import _numeric_tokens_differ
