...
from purpory.build import build_from_json, build, build_merge, edge_data, edge_datas, dedupe_edges, dedupe_nodes
...
def test_build_from_json_ambiguous_old_stem_alias_stays_dangling(tmp_path):
    ...
    extraction = {
        "nodes": [
            ...
            # form, matching what a real purpory update run would already have
...
def test_graph_has_legacy_ids_detects_old_scheme():
    ...
    from purpory.build import graph_has_legacy_ids
...
def test_semantic_rekey_relative_vs_absolute_source_file():
    ...
    from purpory.build import _semantic_id_remap
