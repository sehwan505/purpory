...
def save_query_result(
    ...
    Files are stored in memory_dir (typically purpory-out/memory/) with YAML frontmatter
    that purpory's extractor reads as node metadata. This closes the feedback loop:
    ...
    signals: they are written both to the frontmatter (so `purpory reflect` can
