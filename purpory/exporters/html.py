"""html — moved verbatim from purpory/export.py."""
...
def _viz_node_limit() -> int:
    """Return the effective viz node limit, honoring PURPORY_VIZ_NODE_LIMIT env var.
    ...
    """
    import os
    raw = os.environ.get("PURPORY_VIZ_NODE_LIMIT")
...
// (purpory add) can contain a double-quote; dropping the stringified id
...
def to_html(
    ...
    if G.number_of_nodes() > limit:
        ...
        raise ValueError(
            ...
            f"(limit: {limit}). Use --no-viz, raise PURPORY_VIZ_NODE_LIMIT, "
