"""Shared constants/helpers for the purpory exporters package.

Symbols used by more than one exporter live here so each exporter module can be
split out of purpory/export.py without a circular import (export.py and the
...
# Obsidian exporters. Moved verbatim from purpory/export.py.
COMMUNITY_COLORS = [
