"""objc — moved verbatim from purpory/extract.py."""
from __future__ import annotations

from purpory.extractors.base import _file_stem, _make_id, _read_text
from purpory.extractors.engine import _cpp_declarator_name, _semantic_reference_edge
from purpory.extractors.resolution import _resolve_c_include_path
