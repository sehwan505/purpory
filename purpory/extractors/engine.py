"""engine — moved verbatim from purpory/extract.py."""
from __future__ import annotations

import hashlib
import importlib
from purpory.extractors.base import _LANGUAGE_BUILTIN_GLOBALS, _file_stem, _make_id, _read_text
from purpory.ids import normalize_id
from purpory.extractors.models import LanguageConfig
from purpory.extractors.resolution import _resolve_js_import_target
...
def _csharp_member_type_table(root, source: bytes) -> dict[str, str]:
    ...
    shadowing the same name is a conservative approximation purpory already accepts
