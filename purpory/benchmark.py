"""Token-reduction benchmark - measures how much context purpory saves vs naive full-corpus approach."""
...
from purpory.serve import _query_terms
...
def print_benchmark(result: dict) -> None:
    ...
    print(f"\npurpory token reduction benchmark")
    print(_hr(50))
    arrow = _safe("→", "->")
